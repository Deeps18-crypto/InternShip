export const Mockdata = [
  {
    title: "Confirmed : 1",
    startDate: new Date(2020, 10, 24, 6, 35),
    endDate: new Date(2020, 10, 24, 7, 30),
    id: 0,
    location: "Room 1",
  },
  {
    title: "Book Flights to San Fran for Sales Trip",
    startDate: new Date(2020, 10, 22, 6, 11),
    endDate: new Date(2020, 10, 22, 8, 17),
    id: 1,
    location: "Room 1",
  },
  {
    title: "Install New Router in Dev Room",
    startDate: new Date(2020, 10, 23, 8, 30),
    endDate: new Date(2020, 10, 23, 9, 35),
    id: 2,
    location: "Room 2",
  },
  {
  ...
  },
  {
    ...
    endDate: new Date(2020, 10, 27, 13, 35),
    id: 4,
    location: "Room 2",
  },
  {
    title: "New Brochures",
    startDate: new Date(2020, 5, 26, 7, 30),
    endDate: new Date(2020, 5, 26, 8, 45),
    id: 5,
    location: "Room 2",
  },
  {
    title: "Install New Database",
    startDate: new Date(2018, 5, 27, 6, 20),
    endDate: new Date(2018, 5, 27, 8, 10),
    id: 6,
    location: "Room 1",
  },
  {
    title: "Approve New Online Marketing Strategy",
    startDate: new Date(2018, 5, 22, 9, 0),
    endDate: new Date(2018, 5, 22, 11, 0),
    id: 7,
    location: "Room 3",
  },
  {
    title: "Upgrade Personal Computers",
    startDate: new Date(2018, 5, 27, 13, 15),
  ...
  },
  {
    ...
    startDate: new Date(2020, 10, 3, 0, 0),
    endDate: new Date(2020, 10, 4, 10, 30),
    id: 36,
    location: "Room 3",
  },
  {
    title: "Rollout of New Website and Marketing Brochures",
    startDate: new Date(2020, 10, 5, 10, 0),
    endDate: new Date(2020, 10, 9, 14, 30),
    id: 37,
    location: "Room 3",
  },
  {
