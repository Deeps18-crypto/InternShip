    ...
    return (
     <div className="content">
        <div className="content__bookmark">
            <h4>XYZ Hospital</h4>
            <img  className="content__bookmarkimg" src={Bookmark} onClick={BookmarkHandler} value={values.img}/>
            </div>
            ...
            <div className="content__logo"> 
             ...
             <div className="content__logo3">
                <img  src={Clock}/>CRN, Anesthesia
                <h2>$41.00/hr</h2>
            </div><br/>
        </div>
          <button className="content__button1" onClick={ClickHandler}>Easy Apply</button>
