...
const validate = (values) => {
  ...
  } else if (!values.name.match(data)) {
    errors.name = "should be alphabet";
  }
  ...
  } else if (!values.organisation.match(data)) {
    errors.organisation = "should be alphabet";
  }
  if (!values.role.trim()) {
    errors.role = "required";
  } else if (!values.role.match(data)) {
    errors.role = "should be alphabet";
  }
